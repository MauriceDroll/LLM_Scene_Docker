...
static const _Detection_type_support_symbol_names_t _Detection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_detector_tensorflow_interfaces, msg, Detection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_detector_tensorflow_interfaces, msg, Detection)),
  }
};
...
{
  return &::object_detector_tensorflow_interfaces::msg::rosidl_typesupport_cpp::Detection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, object_detector_tensorflow_interfaces, msg, Detection)() {
  return get_message_type_support_handle<object_detector_tensorflow_interfaces::msg::Detection>();
}
