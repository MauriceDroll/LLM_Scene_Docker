...
{
  new (message_memory) object_detector_tensorflow_interfaces::msg::Detection(_init);
}

void Detection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_detector_tensorflow_interfaces::msg::Detection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detection_message_member_array[5] = {
  {
    ...
    offsetof(object_detector_tensorflow_interfaces::msg::Detection, class_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_detector_tensorflow_interfaces::msg::Detection, class_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_detector_tensorflow_interfaces::msg::Detection, probability),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_detector_tensorflow_interfaces::msg::Detection, center),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_detector_tensorflow_interfaces::msg::Detection, bounding_box),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detection_message_members = {
  ...
  5,  // number of fields
  sizeof(object_detector_tensorflow_interfaces::msg::Detection),
...
{
  return &::object_detector_tensorflow_interfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_detector_tensorflow_interfaces, msg, Detection)() {
  return &::object_detector_tensorflow_interfaces::msg::rosidl_typesupport_introspection_cpp::Detection_message_type_support_handle;
}
