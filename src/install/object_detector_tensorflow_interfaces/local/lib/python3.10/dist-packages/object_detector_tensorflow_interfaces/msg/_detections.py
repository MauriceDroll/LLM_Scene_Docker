...
class Detections(metaclass=Metaclass_Detections):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<object_detector_tensorflow_interfaces/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['object_detector_tensorflow_interfaces', 'msg'], 'Detection')),  # noqa: E501
    )
