...
#include "object_detector_tensorflow_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
using _Detection__ros_msg_type = object_detector_tensorflow_interfaces__msg__Detection;
...
static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_object_detector_tensorflow_interfaces__msg__Detection(
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_object_detector_tensorflow_interfaces__msg__Detection(
