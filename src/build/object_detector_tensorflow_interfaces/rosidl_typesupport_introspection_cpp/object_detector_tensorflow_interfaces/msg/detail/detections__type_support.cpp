...
{
  new (message_memory) object_detector_tensorflow_interfaces::msg::Detections(_init);
}

void Detections_fini_function(void * message_memory)
{
  auto typed_message = static_cast<object_detector_tensorflow_interfaces::msg::Detections *>(message_memory);
  typed_message->~Detections();
}

size_t size_function__Detections__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<object_detector_tensorflow_interfaces::msg::Detection> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<object_detector_tensorflow_interfaces::msg::Detection> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<object_detector_tensorflow_interfaces::msg::Detection> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const object_detector_tensorflow_interfaces::msg::Detection *>(
    get_const_function__Detections__detections(untyped_member, index));
  auto & value = *reinterpret_cast<object_detector_tensorflow_interfaces::msg::Detection *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<object_detector_tensorflow_interfaces::msg::Detection *>(
    get_function__Detections__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const object_detector_tensorflow_interfaces::msg::Detection *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Detections_message_member_array[3] = {
  {
    ...
    offsetof(object_detector_tensorflow_interfaces::msg::Detections, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(object_detector_tensorflow_interfaces::msg::Detections, image_header),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<object_detector_tensorflow_interfaces::msg::Detection>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(object_detector_tensorflow_interfaces::msg::Detections, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Detections_message_members = {
  "object_detector_tensorflow_interfaces::msg",  // message namespace
  "Detections",  // message name
  3,  // number of fields
  sizeof(object_detector_tensorflow_interfaces::msg::Detections),
...
{
  return &::object_detector_tensorflow_interfaces::msg::rosidl_typesupport_introspection_cpp::Detections_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_detector_tensorflow_interfaces, msg, Detections)() {
  return &::object_detector_tensorflow_interfaces::msg::rosidl_typesupport_introspection_cpp::Detections_message_type_support_handle;
}
