...
bool object_detector_tensorflow_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("object_detector_tensorflow_interfaces.msg._detection.Detection", full_classname_dest, 62) == 0);
  }
  object_detector_tensorflow_interfaces__msg__Detection * ros_message = _ros_message;
  {  // class_id
...
PyObject * object_detector_tensorflow_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("object_detector_tensorflow_interfaces.msg._detection");
