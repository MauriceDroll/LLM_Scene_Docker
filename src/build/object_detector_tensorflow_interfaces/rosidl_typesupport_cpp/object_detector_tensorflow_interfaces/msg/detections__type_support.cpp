...
static const _Detections_type_support_symbol_names_t _Detections_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, object_detector_tensorflow_interfaces, msg, Detections)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, object_detector_tensorflow_interfaces, msg, Detections)),
  }
};
...
{
  return &::object_detector_tensorflow_interfaces::msg::rosidl_typesupport_cpp::Detections_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, object_detector_tensorflow_interfaces, msg, Detections)() {
  return get_message_type_support_handle<object_detector_tensorflow_interfaces::msg::Detections>();
}
