...
static const _Detection_type_support_symbol_names_t _Detection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, object_detector_tensorflow_interfaces, msg, Detection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, object_detector_tensorflow_interfaces, msg, Detection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, object_detector_tensorflow_interfaces, msg, Detection)() {
  return &::object_detector_tensorflow_interfaces::msg::rosidl_typesupport_c::Detection_message_type_support_handle;
}
